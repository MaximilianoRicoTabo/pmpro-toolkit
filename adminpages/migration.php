<div class="wrap">
	...
	?>
	<p class="submit"><input type="submit" id="pmprodev-export-data" class="button button-primary" onsubmit="return false;" value="<?php echo esc_html_e( 'Export PMPro Data', 'pmpro-toolkit' ); ?>"></p>
	<hr/>
		...
		jQuery(document).ready(function() {
			...
			jQuery( '#pmprodev-export-data' ).click( function( event ) {
				...
				if ( export_options.length == 0 ) {
					alert( '<?php echo esc_html_e( 'Please select at least one export option.', 'pmpro-toolkit' ); ?>' );
					return;
				}
